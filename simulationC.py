...
emptyIndex = 0
offsetLine = 39
pT1 = [emptyIndex, 2059, 1790, 1935, 1568, 572, 1218, 1604, 572, 1308, 572, 1630, 5938,
       572, 1656, 1578, 572, 1632, 1590, 1396, 1251, 1694, 1091, 572, 1425, 1630, 1668]
pT2 = [emptyIndex, 572, 572, 572, 572, 1583, 572, 572, 1497, 572, 572, 1525, 1635,
       1473, 572, 572, 1313, 1213, 572, 572, 1482, 572, 572, 572, 572, 572, 572]
pT3 = [emptyIndex, 572, 572, 572, 1595, 1728, 572, 572, 572, 1416, 1413, 572, 1432,
       1389, 572, 572, 572, 572, 1499, 1439, 1632, 1098, 1120, 1406, 1692, 1115, 1108]
pT4 = [emptyIndex, 572, 572, 572, 572, 572, 1072, 1110, 572, 572, 1447, 572,
       572, 572, 1315, 572, 572, 1334, 572, 1590, 572, 572, 572, 572, 572, 572, 572]
pT5 = [emptyIndex, 572, 572, 572, 6587, 572, 572, 572, 572, 1432, 1191, 1358, 572,
       1375, 572, 572, 1475, 1756, 572, 572, 1249, 1609, 1120, 1275, 1110, 1730, 1477]
pT6 = [emptyIndex, 572, 572, 572, 572, 572, 572, 572, 1268, 572, 1582, 1480, 1289,
       572, 572, 1630, 572, 1656, 1733, 572, 1296, 1330, 1416, 572, 1458, 1730, 572]
pT7 = [emptyIndex, 286, 286, 286, 286, 1315, 853, 1392, 286, 1127, 286, 1211, 286,
       286, 1225, 286, 286, 1315, 286, 1022, 286, 286, 1215, 910, 286, 1463, 1163]  # 655
...
for iteration in range(1, 1000000):
    ...
    jobId.remove(40-offsetLine)
    jobId.remove(49-offsetLine)
    jobId.insert(0, 62-offsetLine)
    jobId.insert(25, 41-offsetLine)
    jobId.insert(24, 40-offsetLine)
    jobId.insert(1, 49-offsetLine)
